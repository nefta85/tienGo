          ...
          <tbody>
            ...
            <tr>
              ...
              <td class="text-right"><?php if ($product['price']) { ?>
                ...
                <?php } ?></td>
              <td class="text-right"><button type="button" onclick="cart.addcart('<?php echo $product['product_id']; ?>');" data-toggle="tooltip" title="<?php echo $button_cart; ?>" class="btn btn-primary"><i class="fa fa-shopping-cart"></i></button>
