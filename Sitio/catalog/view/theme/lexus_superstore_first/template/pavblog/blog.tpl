	...
	<div class="row">
		...
		<div id ="blog-info" class="pav-blog wrapper blog-wrapper">
				...
				<div class="blog-meta">
					...
					<span class="author"><span><i class="fa fa-pencil"></i><?php echo $objlang->get("text_write_by");?></span> <span class="t-color"><?php echo $blog['author'];?></span></span>
					<?php } ?>
					...
					<span class="created"><i class="fa fa-calendar"></i><?php echo $objlang->get("text_created_date");?> <?php echo $blog['created'];?></span>
					<?php } ?>
								...
								$("#comment-form").submit( function(){
									$.ajax( {type: "POST",url:$("#comment-form").attr("action"),data:$("#comment-form").serialize(), dataType: "json",}).done( function( data ){
										if( data.hasError ){
											...
											$( "#comment-form .message" ).html( '<?php echo $objlang->get("text_add");?>' ).show();
										}
									} );
									return false;
								} );
