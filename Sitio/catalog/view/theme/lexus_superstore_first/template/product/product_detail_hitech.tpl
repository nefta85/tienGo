        ...
        <div id="product" class="product-extra ">
            ...
            <div class="action pull-left">
                ...
                <div class="wishlist" style="display:none;">  
                    <a class="btn btn-theme-default" title="<?php echo $button_wishlist; ?>" onclick="wishlist.addwishlist('<?php echo $product_id; ?>');"><?php echo $button_wishlist; ?></a>
                </div>
                <div class="compare" style="display:none;">
                    <a class="btn btn-theme-default" title="<?php echo $button_compare; ?>" onclick="compare.addcompare('<?php echo $product_id; ?>');"><?php echo $button_compare; ?></a>
                </div>
            </div>
