...
class ControllerSellerAccountProduct extends ControllerSellerAccount {
	...
	public function jxSubmitProduct()
	{
		...
		if ((float)$data['product_price'] == 0) {
			...
			$json['errors']['product_price'] = $this->language->get('ms_error_product_price_high');
				...
				if ( ($this->config->get('msship_download_limit_applies') == 0) || ($this->config->get('msship_download_limit_applies') == 1 && ( ($this->config->get('msconf_enable_shipping') == 2 && $data['product_enable_shipping'] == 0) || $this->config->get('msconf_enable_shipping') == 1) ) ) {
	...
	private function _initForm()
	{
		...
		$this->document->addScript('catalog/view/javascript/account-product-form.js');
				...
				$this->document->addScript('catalog/view/javascript/tab-shipping.js');
		...
		$this->data['msconf_downloads_limits'] = $this->config->get('msconf_downloads_limits');
				...
				$this->data['msship_download_limit_applies'] = $this->config->get('msship_download_limit_applies');
